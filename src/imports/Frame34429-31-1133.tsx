function LiquidEffect() {
  return <div className="absolute backdrop-blur-[1.5px] bg-[rgba(255,255,255,0.12)] inset-[-6.5px_-21px]" data-name="liquid-effect" />;
}
...
function Container36() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative rounded-[24px] shadow-[0px_20px_40px_0px_rgba(0,0,0,0.12)] shrink-0 w-full" data-name="Container">
      <Container />
      <Container35 />
    </div>
  );
...
export default function Frame2() {
  return (
    <div className="content-stretch flex flex-col items-start p-[60px] relative size-full">
      <Btn />
    </div>
  );
}