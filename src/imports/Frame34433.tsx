...
function Frame() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-1/2 px-[20px] md:px-[60px] py-[10px] top-[69px] translate-x-[-50%] w-full max-w-[1440px]">
      <div className="css-g0mm18 flex flex-col font-extrabold justify-center leading-[0] relative shrink-0 text-[#1d1d1f] text-[60px] md:text-[100px] lg:text-[185.395px]">
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] h-full items-center lg:items-start justify-end px-[40px] md:px-[60px] lg:px-0 lg:pl-[60px] pt-[60px] pb-[80px] relative shrink-0 w-full lg:w-[432px]">
      <Btn1 />
      <Frame1 />
    </div>
  );
...
export default function Frame20() {
  return (
    <div className="content-stretch flex flex-col items-start relative w-full min-h-screen">
      <style>{`
        .wavy-gradient-bg {
          background: linear-gradient(to bottom, #D8D7D7 20%, #4A4A4A 50%, #1D1D1F 100%);
        }
      `}</style>
